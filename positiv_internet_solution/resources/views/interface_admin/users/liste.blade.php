...
@section('title')
Positive Internet Solution | Liste Utilisateur
@endsection
    ...
    <main role="main" class="main-content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            <h2 class="page-title">Liste Utilisateurs</h2>
            <p> </p>
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$utilisateur->client_nom}}</td>
                          <td>{{$utilisateur->email}}</td>
                          <td>{{$utilisateur->client_telephone}}</td>
                          <td>{{$utilisateur->pays}}</td>
                          <td>
                            @if($utilisateur->client_status == 1)
                               <div class="custom-control custom-switch">
                                   <button class="btn btn-primary" onclick="editAdminStatus({{$utilisateur->id}})"><i class='fe fe-check'></i></button>
                            ...
                            @else
                               ...
                               <button class="btn btn-danger" onclick="editAdminStatus({{$utilisateur->id}})"><i class='fe fe-power'></i></button>
    ...
    toastr.options.preventDuplicates = true;
        ...
        function editAdminStatus(id){
           //var table = $('#datatable').DataTable();
            ...
            $.get('adminOne/'+id, function(admin){
                $("#id").val(admin.id);
                ...
                $.ajax({
                    url:"{{route("admin.admin_status_update", "id")}}",
                    type:'GET',
                    data:{
                        id:id,
