    ...
    <main role="main" class="main-content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            <h2 class="page-title">Liste Administrateurs</h2>
            <p> </p>
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$admin->admin_name}} {{$admin->admin_prenom}}</td>
                          <td>{{$admin->email}}</td>
                          ...
                          <td>
                            @if($admin->admin_status == 1)
                               <div class="custom-control custom-switch">
                                   <button class="btn btn-primary" onclick="editAdminStatus({{$admin->id}})"><i class='fe fe-check'></i></button>
                            ...
                            @else
                               ...
                               <button class="btn btn-danger" onclick="editAdminStatus({{$admin->id}})"><i class='fe fe-power'></i></button>
