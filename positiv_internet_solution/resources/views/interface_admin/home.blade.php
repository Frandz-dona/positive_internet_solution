...
@section('title')
Positive Internet Solution | Dashboard
@endsection
              ...
              <div class="card shadow border-0">
                <div class="card-body">
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                      <p class="small text-muted mb-0">FORMATIONS</p>
                ...
                <div class="card shadow border-0">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <p class="small text-muted mb-0">AFFILIATIONS</p>
                        <span class="h3 mb-0">$80</span>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card shadow border-0">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <p class="small text-muted mb-0">TRANSATIONS</p>
                        <span class="h3 mb-0">$80</span>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card shadow border-0">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <p class="small text-muted mb-0">FICHIERS</p>
                        <span class="h3 mb-0">$80</span>
                      </div>
                    </div>
                  </div>
