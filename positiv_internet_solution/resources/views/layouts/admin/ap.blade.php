...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="vertical  dark  ">
    ...
    <div class="wrapper">
      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="{{url('/admin/admin_home')}}">
              <img src="{{asset('client/logo/lg.png')}}" alt="" width='120px' height='120px'>
            </a>
          </div>
          <ul class="navbar-nav flex-fill w-100 mb-2">
            {{-- <li class="nav-item dropdown">
              <a href=" {{route('admin.home')}} " data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                <i class="fe fe-home fe-16"></i>
                <span class="ml-3 item-text">Dashboard</span><span class="sr-only">(current)</span>
              </a>
            </li> --}}
            <li class="nav-item">
                <a class="nav-link pl-3" href=" {{route('admin.home')}} "><span class="ml-1 item-text">DASHBOARD</span></a>
              </li>
          </ul>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            @if( Auth::guard('admin')->user()->admin_role == 'root' )
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                <li class="nav-item">
                  <a class="nav-link pl-3" href=" {{route('admin.admin_liste')}} "><span class="ml-1 item-text">Liste</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href=" {{route('admin.register')}} "><span class="ml-1 item-text">Ajout</span></a>
                </li>
                {{-- <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              <a href="#livres" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">LIVRE</span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="livres">
                <li class="nav-item">
                  <a class="nav-link pl-3" href=" {{route('admin.livre_liste')}} "><span class="ml-1 item-text">Liste</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href=" {{route('admin.livre_page_ajout')}} "><span class="ml-1 item-text">Ajout</span></a>
                </li>
            ...
            <li class="nav-item dropdown">
                <a href="#publication" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
            ...
            <li class="nav-item dropdown">
                <a href="#formation" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe fe-book fe-16"></i>
                  <span class="ml-3 item-text">FORMATIONS</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <a href="#commande" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe fe-shopping-cart fe-16"></i>
                  <span class="ml-3 item-text">COMMANDES</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="commande">
                  <li class="nav-item">
                    <a class="nav-link pl-3" href="./table_basic.html"><span class="ml-1 item-text">Liste</span></a>
                  </li>
                  {{-- <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                <a href="#affiliation" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe fe-user-plus fe-16"></i>
                  <span class="ml-3 item-text">AFFILIATIONS</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="affiliation">
                  <li class="nav-item">
                    <a class="nav-link pl-3" href="./table_basic.html"><span class="ml-1 item-text">Liste</span></a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                <a href="#transation" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe
                  fe-activity  fe-16"></i>
                  <span class="ml-3 item-text">TRANSATIONS</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="transation">
                  <li class="nav-item">
                    <a class="nav-link pl-3" href="./table_basic.html"><span class="ml-1 item-text">Liste</span></a>
                  </li>
                  {{-- <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                <a href="#fichier" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe fe-folder  fe-16"></i>
                  <span class="ml-3 item-text">FICHIERS</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="fichier">
                  <li class="nav-item">
                    <a class="nav-link pl-3" href="./table_basic.html"><span class="ml-1 item-text">Liste</span></a>
                  </li>
                  {{-- <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                <a href="#categorie" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                  <i class="fe fe-folder  fe-16"></i>
                  <span class="ml-3 item-text">CATEGORIE</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="categorie">
                  <li class="nav-item">
                    <a class="nav-link pl-3" href=" {{route('admin.categorie_liste')}} "><span class="ml-1 item-text">Liste</span></a>
                  </li>
      ...
      <main class="py-4" role="main" class="main-content">
        @yield('content')
        </main>
    ...
    <!-- toastr -->
    <script src=" {{asset('admin/assets/sweetalerte2/sweetalert2.min.js')}} "></script>
